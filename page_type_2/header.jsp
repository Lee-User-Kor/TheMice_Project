	...
	<div class="header">
		<div class="header_inner_wrap">
			<div class="header_logo">
				<img class="logo_img" src="${root }/img/website2/header_logo.png" onclick="location.href = '${root}/website2'">
			</div>
			<ul>
				<li style="background-color: #1D1D1D!improtant;"><a href="#"></a></li>
				<li><a href="${root }/website2/#cnt02">갤러리</a></li>
				<li><a href="${root }/website2/#cnt03">전시소개</a></li>
				<li><a href="${root }/website2/#cnt04">공지사항</a></li>
				<li><a href="${root }/website2/#cnt05">위치안내</a></li>
				<li><a href="${root }/website2/#cnt06">환불규정</a></li>
				<li><a href="${root }/website2/#cnt07">영상</a></li>
