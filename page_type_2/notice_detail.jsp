...
<div class="notice_detail_wrap">
	<div class="nd_inner_wrap">
		<div class="nd_title"><span>[부산 광역시] COVID 19로 공연일정 연기 안내드립니다.</span></div>
		<table class="nd_table">
			<tbody>
				<tr class="f_tr">
					<th>작성일</th>
					<td class="f_td">2021-06-15 14:30:09</td>
					<th>조회순</th>
					<td class="s_td">250</td>
				</tr>
				<tr>
					<th>첨부파일</th>
		...
		<div class="nd_content">
			부산경제진흥원 관광·마이스업 특별취업지원센터가<br>
			“제 2~3차 취업성공 ALL-PASS 과정”을 진행합니다!!!
		</div>
		<div class="nd_img"><img src="${root }/img/website2/notice_detail_sample.png"></div>
		<div class="nd_btn_function"><button class="nd_btn" onclick="location.href = '${root}/website2/notice'">목록</button></div>
	</div>
</div>
